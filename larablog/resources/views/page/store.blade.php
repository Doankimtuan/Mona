    ...
    <div>
      ...
      <div class="cpntainer">
        <div class="raucu" ; class="danhmuc" ; class="item-img">
          <a href="#">
            <img src="https://mauweb.monamedia.net/cleverfood/wp-content/uploads/2019/05/product-9-470x470-100x100.jpg"
              alt="news">
          </a>
        </div>
        <div class="item-text">
      ...
      <div class="cpntainer">
        <div class="raucu" ; class="danhmuc" ; class="item-img">
          <a href="#">
            <img src="https://mauweb.monamedia.net/cleverfood/wp-content/uploads/2019/05/product-24-470x470-100x100.jpg"
              alt="news">
          </a>
        </div>
        <div class="item-text">
      ...
      <div class="cpntainer">
        <div class="raucu" ; class="danhmuc" ; class="item-img">
          <a href="#">
            <img src="https://mauweb.monamedia.net/cleverfood/wp-content/uploads/2019/05/product-15-470x470-100x100.jpg"
              alt="news">
          </a>
        </div>
        <div class="item-text">
      ...
      <div class="cpntainer">
        <div class="raucu" ; class="danhmuc" ; class="item-img">
          <a href="#">
            <img src="https://mauweb.monamedia.net/cleverfood/wp-content/uploads/2019/05/product-12-470x470-100x100.jpg"
              alt="news">
          </a>
        </div>
        <div class="item-text">
      ...
      <div class="cpntainer">
        <div class="raucu" ; class="danhmuc" ; class="item-img">
          <a href="#">
            <img src="https://mauweb.monamedia.net/cleverfood/wp-content/uploads/2019/05/product-16-470x470-100x100.jpg"
              alt="news">
          </a>
        </div>
        <div class="item-text">
